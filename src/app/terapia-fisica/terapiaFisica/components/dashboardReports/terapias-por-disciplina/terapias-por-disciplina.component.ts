...
@Component({
  selector: 'app-terapias-por-disciplina',
  templateUrl: './terapias-por-disciplina.component.html',
  styleUrls: ['./terapias-por-disciplina.component.css']
})
export class TerapiasPorDisciplinaComponent {
